...
const Home = ({ showToast }) => {
  ...
  const [events, setEvents] = useState([
    ...
    {
      id: 'event-hackathon',
      title: 'Hackathon 2024: Innovate for Green',
      category: 'Công nghệ',
      date: '25/05/2024',
      time: '08:00',
    ...
    <div className="home-layout">
            ...
            <div className="auth-profile-wrapper">
              {isLoggedIn ? (
                <div className="profile-display-card">
                  ...
                  <Link to="/profile" className="profile-avatar-link" title="Đến trang cá nhân của bạn">
      ...
      <footer className="home-footer">
        ...
        <div className="footer-bottom-row">
          <p className="copyright-text">© 2024 FPT Event Platform. All rights reserved.</p>
