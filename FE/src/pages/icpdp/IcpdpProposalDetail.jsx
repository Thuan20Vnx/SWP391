...
const IcpdpProposalDetail = () => {
  ...
  return (
    <div className="ctsv-ed-page">
      ...
      {/* ── Status Banners ── */}
      {canIcpdpApprove && (
        <div className="icpdp-view-banner" style={{ borderColor: 'rgba(242, 111, 33, 0.4)', background: 'rgba(242, 111, 33, 0.06)' }}>
      ...
      {!canIcpdpApprove && proposal.statusKey === 'approved' && (
        <div className="icpdp-view-banner" style={{ borderColor: 'rgba(34, 197, 94, 0.3)', background: 'rgba(34, 197, 94, 0.06)' }}>
