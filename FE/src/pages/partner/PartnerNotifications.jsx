...
const PartnerNotifications = () => {
  ...
  const items = useMemo(
    () => notifications.map((n) => mapSysNotif(n, 'partner')),
    [notifications]
  );
  ...
  return (
    <div className="ctsv-notifications-page partner-notifications-page">
      <header className="ctsv-events-hero">
        <div className="ctsv-events-hero-text">
          ...
          <h1>Thông báo đối tác</h1>
          <p>Cập nhật về hồ sơ đối tác, đề xuất sự kiện, hợp đồng và tất toán.</p>
        </div>
