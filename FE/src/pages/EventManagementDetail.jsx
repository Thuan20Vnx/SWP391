...
const EventManagementDetail = ({ showToast }) => {
  ...
  const [userProfile, setUserProfile] = useState({ fullname: 'Admin - FU-DEVER', course: '', picture: defaultAvatar, role: 'club_manager' });
  ...
  return (
    <div className="event-detail-page">
      {/* 1. Header (Reusing Home header styles but tailored) */}
      <header className="home-header">
        <div className="header-container">
          <div className="header-logo" onClick={() => navigate('/')}>
            <img src={fptLogo} alt="F Events" className="logo-img" />
          </div>
          
          <nav className="header-nav">
            <Link to="/" className="nav-link">Trang chủ</Link>
            <Link to="/events" className="nav-link">Sự kiện</Link>
            <a href="#" className="nav-link">Câu lạc bộ</a>
            <a href="#" className="nav-link">Tin tức</a>
            <Link to="/quan-ly-clb" className="nav-link nav-link-manager active">Quản lý CLB</Link>
          </nav>

          <div className="header-search-box" style={{ maxWidth: '280px' }}>
            <span className="search-icon-inside">
              <svg viewBox="0 0 24 24" width="18" height="18"><path d="M15.5 14h-.79l-.28-.27A6.471 6.471 0 0 0 16 9.5 6.5 6.5 0 1 0 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z" fill="currentColor"/></svg>
            </span>
          ...
          <div className="header-actions">
            ...
            <div className="profile-display-card">
              ...
              <div className="profile-avatar-circle" onClick={handleLogout}>
