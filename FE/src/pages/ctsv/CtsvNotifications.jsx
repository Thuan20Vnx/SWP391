    ...
    <div className="ctsv-notifications-page">
      <header className="ctsv-events-hero">
        <div className="ctsv-events-hero-text">
          ...
          <h1>Thông báo</h1>
          <p>Tình trạng đơn, timeline sự kiện, phê duyệt và các hoạt động hệ thống liên quan tới CTSV.</p>
        </div>
...
export default CtsvNotifications;
