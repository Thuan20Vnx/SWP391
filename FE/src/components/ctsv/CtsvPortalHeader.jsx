...
import CtsvProfileMenu from './CtsvProfileMenu';
...
const resolveActiveMenuItem = (pathname) => {
  ...
  if (pathname.startsWith('/ctsv/profile')) return 'profile';
  return '';
};
...
const CtsvPortalHeader = ({
  ...
  const handleProfileMenuAction = (action) => {
    setProfilePopupOpen(false);
    const route = CTSV_MENU_ROUTES[action];
  ...
  return (
    <header
      className={`home-header ctsv-portal-header${showSearch ? ' ctsv-portal-header--with-search' : ''}`}
    >
      <div className="header-container">
        ...
        {showSearch && (
          <div className="header-search-box ctsv-header-search">
            ...
            <input
              type="text"
              placeholder="Tìm kiếm sự kiện, đề xuất…"
              value={searchQuery}
            ...
            <div className="profile-display-card">
              ...
              >
                <div className="profile-info-text">
                  ...
                  <span className="profile-role profile-role-ctsv">{roleLabel}</span>
                </div>
              ...
              {profilePopupOpen && (
                <>
                  <div
                    ...
                    role="presentation"
                  />
                  <div className="profile-menu-dropdown" role="menu" aria-label="Menu tài khoản CTSV">
                    <CtsvProfileMenu
