...
const NavItem = ({ icon, label, active, onClick }) => (
  <button
    type="button"
    className={`nav-hub__item ${active ? 'nav-hub__item--active' : ''}`}
    onClick={onClick}
  >
    {icon}
    ...
    <div className="nav-hub nav-hub--compact">
      <header className="nav-hub__header">
        ...
        <div className="nav-hub__header-text">
          <h3 className="nav-hub__name">{userProfile?.fullname || 'Cán bộ CTSV'}</h3>
      ...
      <section className="nav-hub__section nav-hub__section--menu">
        ...
        <button type="button" className="nav-hub__qr-btn" onClick={act('create-event')}>
          <Icon size={16}>
            <line x1="12" y1="5" x2="12" y2="19" />
            <line x1="5" y1="12" x2="19" y2="12" />
          </Icon>
          <span>Tạo sự kiện trường</span>
        </button>
      </section>
