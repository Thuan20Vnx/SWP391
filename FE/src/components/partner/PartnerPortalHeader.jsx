...
const PartnerPortalHeader = ({
  ...
  return (
    <header
      className={`home-header ctsv-portal-header partner-portal-header${showSearch ? ' ctsv-portal-header--with-search' : ''}`}
    >
      <div className="header-container">
        <div className="ctsv-header-start">
          ...
          <nav className={`header-nav ctsv-header-nav ${mobileNavOpen ? 'mobile-active' : ''}`}>
            ...
            <Link
              ...
              className={`nav-link nav-link-ctsv-pill partner-pill ${path.startsWith('/partner/dashboard') ? 'is-current' : ''}`}
              onClick={closeMobileNav}
            >
              Đối tác
            </Link>
        ...
        <div className="header-actions">
          ...
          <button
            ...
            onClick={() => showToast?.('Có cập nhật mới về đề xuất sự kiện của bạn.', 'info')}
